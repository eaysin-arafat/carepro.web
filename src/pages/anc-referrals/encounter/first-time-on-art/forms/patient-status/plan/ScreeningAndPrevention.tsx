        ...
        <div>
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 items-center justify-center">
              <Select label="Malaria Dose" placeholder="Select Malaria Dose">
