...
import InitialAlreadyPatientLocator from "./step/PatientLocator.tsx";
import InitialAlreadyPatientStatus from "./step/PatientStatus.tsx";

const InitialAlreadyOnARTEncounter = () => {
...
export default InitialAlreadyOnARTEncounter;
