...
const MotherDetails = ({ toggler = () => {} }) => {
  const [terminationReasonSelect, setTerminationReasonSelect] = useState(null);

  const handleTerminationalReson = (event) => {
    setTerminationReasonSelect(event.target.value);
  };
        ...
        <div>
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 items-center justify-center">
              <Input label="Pregnancy No." placeholder="Enter Pregnancy No." />
              <DatePicker
            ...
            <div className="flex gap-2 items-center justify-center">
              ...
              <Select
                ...
                className="py-1 rounded"
                disabled={terminationReasonSelect !== "Early termination"}
              >
                <option value="">Elective abortion</option>
                <option value="">Spontaneous complete abortion</option>
                <option value="">Spontaneous missed abortion</option>
                <option value="">Spontaneous septic abortion</option>
                <option value="">Spontaneous threatened abortion</option>
                <option value="">Spontaneous inevitable abortion</option>
              </Select>
            ...
            <div className="flex gap-2 items-center justify-center">
              ...
              <Select label="Dalivery Method" className="py-1 rounded">
                <option>Early termination</option>
                <option>SVD</option>
                <option>BRE</option>
                <option>VAC</option>
              ...
              <Select label="Puerperium Outcome" className="py-1 rounded">
