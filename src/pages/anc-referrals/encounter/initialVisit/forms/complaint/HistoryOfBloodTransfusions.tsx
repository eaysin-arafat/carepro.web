        ...
        <div>
          <div className="flex flex-col gap-3">
            <div className="flex gap-2 items-center justify-center">
              ...
              <Select label="Blood Group" className="py-3 rounded">
            ...
            <div className="flex gap-2 items-center justify-center">
              <Select label="Partner Blood Group" className="py-1 rounded">
                <option value="">A +ive</option>
                <option value="">A -ive</option>
                <option value="">B +ive</option>
                <option value="">B -ive</option>
              ...
              <Select label="RH Sensitivity" className="py-1 rounded">
